...
memarg.add_argument("--size", type=int, default=1000, help="Memory size.")
...
dqnarg.add_argument("--train_steps", type=int, default=50000, help="Number of training steps.")
...
dqnarg.add_argument("--replay_start_size", type=int, default=5000, help="A uniform random policy is run for this number of frames before learning starts and the resulting experience is used to populate the replay memory.")
